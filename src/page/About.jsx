...
const About = () => {
  return (
    <div className="relative h-screen mt-16 md:mt-24 xl:mt-32 xs:mx-2 md:mx-10 overflow-hidden">
      <img
        src={Home_Slider2}
        alt="about"
      ...
      <div className="relative text-white p-1 xs:p-2 md:p-4 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 xs:gap-5 md:gap-10 xl:gap-20 mx-2 xs:mx-4 md:mx-9 mt-5 md:mt-12">
          ...
          <div className="space-y-2 md:space-y-7 mt-2 md:mt-5 font-bold" data-aos="slide-left">
